"""
cscv_pitsm.py
CSCV / PBO wired to strategy_pitsm.run_backtest().
Same API as cscv.py / cscv_itsm.py.
"""
...
from strategy_pitsm import run_backtest

ALLOWED_KEYS = {'itsm_bars', 'itsm_threshold', 'atr_period', 'atr_stop_mult'}
